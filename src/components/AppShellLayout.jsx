...
// path จาก Heroicons 24/outline (assets/heroicons — MIT): home, chat-bubble-left-right, trophy, calendar-days
const ICON_PATHS = {
  quest: [
  ...
  plan: [
    "M6.75 3v2.25m10.5-2.25v2.25M3.75 8.25h16.5M5.25 4.5h13.5c.828 0 1.5.672 1.5 1.5v13.5c0 .828-.672 1.5-1.5 1.5H5.25a1.5 1.5 0 0 1-1.5-1.5V6c0-.828.672-1.5 1.5-1.5Z",
    "M7.5 12h3m-3 3h3m3-3h3m-3 3h3",
  ],
};
...
// 4 ทางหลัก (เควส/โค้ช/อันดับ/แผนสอบ) — เพิ่มแท็บใหม่ในอนาคตแค่ต่อ array (กริดคอลัมน์ + แถบ active อ้าง .length/index เอง)
const NAV_ITEMS = [
  ...
  { to: "/plan", label: "แผนสอบ", icon: ICON_PATHS.plan },
];
